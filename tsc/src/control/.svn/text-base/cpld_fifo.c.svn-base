 ...
 * 说明:
 */
int cpld_fifo_capacity(cpld_fifo_t* self)
{

	
	if(self->m_write_p >= self->m_read_p)
		return (MAX_BUFFER_LEN - 1 - (self->m_write_p - self->m_read_p));
	else
		return (self->m_read_p - self->m_write_p -1);
