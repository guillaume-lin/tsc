...
public:
		...
		:CBaseMenu(8,16,(lines()-8)/2,(cols()-16)/2)
	{
		...
		I[0] = new MenuItem_T<CSetTimeForm>("时间设置");
		I[1] = new MenuItem_T<CLampSettingForm>("信号灯设置");		
		I[2] = new MenuItem_T<CLampGroupSettingForm>("灯组设置");
		I[3] = new MenuItem_T<CDetectorSettingForm>("检测器设置");
		I[4] = new MenuItem_T<CGreenConflictForm>("绿冲突设置");
