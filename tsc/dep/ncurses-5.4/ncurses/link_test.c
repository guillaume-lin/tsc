...
{
	T((T_CALLED("standend()"))); returnAttr((((stdscr)->_attrs = (0L))));
}
...
{
	T((T_CALLED("(%s,%#lx)"), _nc_visbuf2(0,a1))); returnPtr(tparm(a1));
}
...
{
	T((T_CALLED("vwprintw(%p,%s,%p)"), a1, _nc_visbuf2(1,a2), z)); returnCode(vwprintw(a1, a2, z));
}
...
{
	T((T_CALLED("vwscanw(%p,%s,%p)"), a1, _nc_visbuf2(1,a2), z)); returnCode(vwscanw(a1, a2, z));
}
...
{
	T((T_CALLED("wstandend(%p)"), z)); returnAttr((((z)->_attrs = (0L))));
}
